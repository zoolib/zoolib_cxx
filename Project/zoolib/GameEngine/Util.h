...
ZQ<Map_Any> sQReadMap_Any(const ZRef<ZStreamerR>& iStreamerR, const string8* iName = nullptr);
...
Val_Any sReadBin(const ZRef<ChannerR_Bin>& iStreamerR);
...
ZDCPixmap sPixmap_PNG(const ZRef<ChannerR_Bin>& iStreamerR);
